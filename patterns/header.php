...
?>
 <div class="touch-menu" id="touchMenu">
      ...
      <nav class="touch-menu-nav">
        <ul>
          <li><a href="home">Home<i class="icon ph ph-caret-right"></i></a></li>
          <li><a href="about">About<i class="icon ph ph-caret-right"></i></a></li>
          <li><a href="research">Research<i class="icon ph ph-caret-right"></i></a></li>
          <li><a href="innovation">Innovation<i class="icon ph ph-caret-right"></i></a></li>
          <li><a href="education">Education<i class="icon ph ph-caret-right"></i></a></li>
          <!--
